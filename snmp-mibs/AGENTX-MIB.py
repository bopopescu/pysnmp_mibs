...
agentxMainAgentXVer = MibScalar((1, 3, 6, 1, 2, 1, 74, 1, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 255))).setMaxAccess("readonly")
if mibBuilder.loadTexts: agentxMainAgentXVer.setDescription("The AgentX protocol version supported by this main agent.\nThe current protocol version is 1.  Note that the main agent\nmust also allow interaction with earlier version subagents.")
