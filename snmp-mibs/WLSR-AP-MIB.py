...
wlsrMode = MibTableColumn((1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 1, 1, 1, 1, 3), Integer().subtype(subtypeSpec=SingleValueConstraint(1,3,2,)).subtype(namedValues=NamedValues(("main", 1), ("adhoc", 2), ("monitor", 3), ))).setMaxAccess("readonly")
if mibBuilder.loadTexts: wlsrMode.setDescription("\nMode of the Access Point. Main indicates that we are\noperating as Access Point. monitor indicates that the\nAP is an Air Monitor.")
