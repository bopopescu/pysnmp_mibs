...
portService = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 1, 1, 4), Integer().subtype(subtypeSpec=SingleValueConstraint(16,9,15,11,17,4,5,10,3,6,13,12,2,7,1,8,14,)).subtype(namedValues=NamedValues(("dslogin", 1), ("vmodem", 10), ("clienttunnel", 11), ("servertunnel", 12), ("modbussubordinate", 13), ("modbusmain", 14), ("customapp", 15), ("signalIo", 16), ("trueport", 17), ("directraw", 2), ("silentraw", 3), ("reverseraw", 4), ("bidirectionalmodem", 5), ("directtelnet", 6), ("silenttelnet", 7), ("reversetelnet", 8), ("udp", 9), ))).setMaxAccess("readwrite")
...
portMODBUSSubordinateTable = MibTable((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 10))
if mibBuilder.loadTexts: portMODBUSSubordinateTable.setDescription("Port Modbus Subordinate Table.")
portMODBUSSubordinateEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 10, 1)).setIndexNames((0, "PERLE-IOLAN-DS1-MIB", "portMODBUSSubordinateIndex"))
if mibBuilder.loadTexts: portMODBUSSubordinateEntry.setDescription("An entry in the portMODBUSSubordinateEntry, each relating to a port.")
portMODBUSSubordinateIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 10, 1, 1), PortNumber()).setMaxAccess("noaccess")
if mibBuilder.loadTexts: portMODBUSSubordinateIndex.setDescription("portMODBUSSubordinateIndex")
portMODBUSSubordinateStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 10, 1, 2), ContainerStatus()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: portMODBUSSubordinateStatus.setDescription("When you perform a GET on this variable, one of\nthe following values will be returned:\n1-Indicates that the container folder is active with no changes.\n2-Indicates that the container folder is active with change(s).\nOnce you have completed setting the variables in a folder, you\nwill want to submit your changes to the Device Server. To do\nthis, set the Status variable to 4. If you want to discard the\nchanges, set the Status variable to 6.\n4-Indicates that the changes in the container folder are to be\n  submitted to the Device Server.\n6-Indicates that the changes in the container folder are to be\n  discarded.")
portMODBUSSubordinateMode = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 10, 1, 3), Integer().subtype(subtypeSpec=SingleValueConstraint(0,1,)).subtype(namedValues=NamedValues(("rtu", 0), ("ascii", 1), ))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: portMODBUSSubordinateMode.setDescription("Modbus serial device's mode: 0: RTU; 1: ASCII.")
portMODBUSSubordinateCRLF = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 10, 1, 4), OnOffValue()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: portMODBUSSubordinateCRLF.setDescription("Enable/disable appending CR/LF")
portMODBUSSubordinateUIDRange = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 10, 1, 5), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 40))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: portMODBUSSubordinateUIDRange.setDescription("The UID range for this entry.")
portMODBUSMainTable = MibTable((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 11))
if mibBuilder.loadTexts: portMODBUSMainTable.setDescription("Port Modbus Main Table.")
portMODBUSMainEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 11, 1)).setIndexNames((0, "PERLE-IOLAN-DS1-MIB", "portMODBUSMainIndex"))
if mibBuilder.loadTexts: portMODBUSMainEntry.setDescription("An entry in the portMODBUSMainEntry, each relating to a port.")
portMODBUSMainIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 11, 1, 1), PortNumber()).setMaxAccess("noaccess")
if mibBuilder.loadTexts: portMODBUSMainIndex.setDescription("portMODBUSMainIndex")
portMODBUSMainStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 11, 1, 2), ContainerStatus()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: portMODBUSMainStatus.setDescription("When you perform a GET on this variable, one of\nthe following values will be returned:\n1-Indicates that the container folder is active with no changes.\n2-Indicates that the container folder is active with change(s).\nOnce you have completed setting the variables in a folder, you\nwill want to submit your changes to the Device Server. To do\nthis, set the Status variable to 4. If you want to discard the\nchanges, set the Status variable to 6.\n4-Indicates that the changes in the container folder are to be\n  submitted to the Device Server.\n6-Indicates that the changes in the container folder are to be\n  discarded.")
portMODBUSMainMode = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 11, 1, 3), Integer().subtype(subtypeSpec=SingleValueConstraint(0,1,)).subtype(namedValues=NamedValues(("rtu", 0), ("ascii", 1), ))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: portMODBUSMainMode.setDescription("Modbus serial device's mode: 0: RTU; 1: ASCII.")
portMODBUSMainCRLF = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 11, 1, 4), OnOffValue()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: portMODBUSMainCRLF.setDescription("Enable/disable appending CR/LF")
...
portMODBUSMainMappingTable = MibTable((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 16))
if mibBuilder.loadTexts: portMODBUSMainMappingTable.setDescription("Modbus Main Subordinate Mapping.")
portMODBUSMainMappingEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 16, 1)).setIndexNames((0, "PERLE-IOLAN-DS1-MIB", "portMODBUSMainPortIndex"), (0, "PERLE-IOLAN-DS1-MIB", "portMODBUSMainMappingIndex"))
if mibBuilder.loadTexts: portMODBUSMainMappingEntry.setDescription("An entry in the portMODBUSMainMappingTable, each relating to a subordinate mapping.")
portMODBUSMainPortIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 16, 1, 1), PortNumber()).setMaxAccess("noaccess")
if mibBuilder.loadTexts: portMODBUSMainPortIndex.setDescription("The port number")
portMODBUSMainMappingIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 16, 1, 2), GenericTableIndex()).setMaxAccess("noaccess")
if mibBuilder.loadTexts: portMODBUSMainMappingIndex.setDescription("The mapping table index")
portMODBUSMainMappingStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 16, 1, 3), ContainerStatus()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: portMODBUSMainMappingStatus.setDescription("When you perform a GET on this variable, one of\nthe following values will be returned:\n1-Indicates that the container folder is active with no changes.\n2-Indicates that the container folder is active with change(s).\nOnce you have completed setting the variables in a folder, you\nwill want to submit your changes to the Device Server. To do\nthis, set the Status variable to 4. If you want to discard the\nchanges, set the Status variable to 6.\n4-Indicates that the changes in the container folder are to be\n  submitted to the Device Server.\n6-Indicates that the changes in the container folder are to be\n  discarded.")
portMODBUSMainMappingRemoteIP = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 16, 1, 4), Ipv4v6Address()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: portMODBUSMainMappingRemoteIP.setDescription("The remote subordinate's IP address.")
portMODBUSMainMappingTransportType = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 16, 1, 5), Integer().subtype(subtypeSpec=SingleValueConstraint(1,0,)).subtype(namedValues=NamedValues(("tcp", 0), ("udp", 1), ))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: portMODBUSMainMappingTransportType.setDescription("The remote subordinate's transport protocol type (TCP/UDP).")
portMODBUSMainMappingPortNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 16, 1, 6), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: portMODBUSMainMappingPortNumber.setDescription("the transport protocol layer port number (TCP/UDP).")
portMODBUSMainMappingUIDStart = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 16, 1, 7), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 247))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: portMODBUSMainMappingUIDStart.setDescription("The start UID of the UID range for this entry.")
portMODBUSMainMappingUIDEnd = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 16, 1, 8), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 247))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: portMODBUSMainMappingUIDEnd.setDescription("The end UID of the UID range for this entry.")
portMODBUSMainMappingUIDRangeMode = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 5, 16, 1, 9), Integer().subtype(subtypeSpec=SingleValueConstraint(0,1,)).subtype(namedValues=NamedValues(("host", 0), ("gateway", 1), ))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: portMODBUSMainMappingUIDRangeMode.setDescription("The UID-IP mapping mode.")
...
ethStatsMainLoadBalancer = MibScalar((1, 3, 6, 1, 4, 1, 1966, 13, 1, 14, 13), YesNoValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ethStatsMainLoadBalancer.setDescription("ethStatsMainLoadBalancer")
ethStatsSubordinateLoadBalancer = MibScalar((1, 3, 6, 1, 4, 1, 1966, 13, 1, 14, 14), YesNoValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ethStatsSubordinateLoadBalancer.setDescription("ethStatsSubordinateLoadBalancer")
...
if mibBuilder.loadTexts: modbusGatewayPortNumber.setDescription("Remote main transport layer (TCP/UDP) port number")
...
if mibBuilder.loadTexts: modbusGatewayUIDAddressMode.setDescription("Subordinate UID address mode.")
...
if mibBuilder.loadTexts: modbusGatewayNextRequestDelay.setDescription("Delay to allow serial subordinates to re-enable receivers before issuing next\nmain request.")
...
if mibBuilder.loadTexts: modbusGatewayIPAliasing.setDescription("Enable/disable modbus subordinate IP Aliasing.")
modbusStatsInfo = MibIdentifier((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25))
modbusSubordinateTCPStatsTable = MibTable((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 1))
if mibBuilder.loadTexts: modbusSubordinateTCPStatsTable.setDescription("Modbus TCP Subordinate Statistics Table.")
modbusSubordinateTCPStatsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 1, 1)).setIndexNames((0, "PERLE-IOLAN-DS1-MIB", "modbusSubordinateTCPStatsPortIndex"))
if mibBuilder.loadTexts: modbusSubordinateTCPStatsEntry.setDescription("An entry in the Modbus/TCP Subordinate statistics table, each relating to a serial port.")
modbusSubordinateTCPStatsPortIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 1, 1, 1), GenericTableIndex()).setMaxAccess("noaccess")
if mibBuilder.loadTexts: modbusSubordinateTCPStatsPortIndex.setDescription("modbusSubordinateTCPStatsPortIndex")
modbusSubordinateTCPStatsSerialMode = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 1, 1, 2), Integer().subtype(subtypeSpec=SingleValueConstraint(0,1,)).subtype(namedValues=NamedValues(("rtu", 0), ("ascii", 1), ))).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateTCPStatsSerialMode.setDescription("Modbus serial device's mode: 0: RTU; 1: ASCII.")
modbusSubordinateTCPStatsSerialFrameErrors = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 1, 1, 3), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateTCPStatsSerialFrameErrors.setDescription("Modbus serial port frame errors")
modbusMainTCPStatsTable = MibTable((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 2))
if mibBuilder.loadTexts: modbusMainTCPStatsTable.setDescription("Modbus TCP Main Statistics Table.")
modbusMainTCPStatsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 2, 1)).setIndexNames((0, "PERLE-IOLAN-DS1-MIB", "modbusMainTCPStatsPortIndex"))
if mibBuilder.loadTexts: modbusMainTCPStatsEntry.setDescription("An entry in the Modbus/TCP Main statistics table, each relating to a serial port.")
modbusMainTCPStatsPortIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 2, 1, 1), GenericTableIndex()).setMaxAccess("noaccess")
if mibBuilder.loadTexts: modbusMainTCPStatsPortIndex.setDescription("modbusMainTCPStatsPortIndex")
modbusMainTCPStatsSerialMode = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 2, 1, 2), Integer().subtype(subtypeSpec=SingleValueConstraint(0,1,)).subtype(namedValues=NamedValues(("rtu", 0), ("ascii", 1), ))).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainTCPStatsSerialMode.setDescription("Modbus serial device's mode: 0: RTU; 1: ASCII.")
modbusMainTCPStatsSerialFrameErrors = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 2, 1, 3), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainTCPStatsSerialFrameErrors.setDescription("Modbus serial port frame errors")
modbusSubordinateUDPStatsTable = MibTable((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 3))
if mibBuilder.loadTexts: modbusSubordinateUDPStatsTable.setDescription("Modbus UDP Subordinate Statistics Table.")
modbusSubordinateUDPStatsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 3, 1)).setIndexNames((0, "PERLE-IOLAN-DS1-MIB", "modbusSubordinateUDPStatsPortIndex"))
if mibBuilder.loadTexts: modbusSubordinateUDPStatsEntry.setDescription("An entry in the Modbus/UDP Subordinate statistics table, each relating to a serial port.")
modbusSubordinateUDPStatsPortIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 3, 1, 1), GenericTableIndex()).setMaxAccess("noaccess")
if mibBuilder.loadTexts: modbusSubordinateUDPStatsPortIndex.setDescription("modbusSubordinateUDPStatsPortIndex")
modbusSubordinateUDPStatsSerialMode = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 3, 1, 2), Integer().subtype(subtypeSpec=SingleValueConstraint(0,1,)).subtype(namedValues=NamedValues(("rtu", 0), ("ascii", 1), ))).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateUDPStatsSerialMode.setDescription("Modbus serial device's mode: 0: RTU; 1: ASCII.")
modbusSubordinateUDPStatsSerialFrameErrors = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 3, 1, 3), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateUDPStatsSerialFrameErrors.setDescription("Modbus serial port frame errors")
modbusMainUDPStatsTable = MibTable((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 4))
if mibBuilder.loadTexts: modbusMainUDPStatsTable.setDescription("Modbus UDP Main Statistics Table.")
modbusMainUDPStatsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 4, 1)).setIndexNames((0, "PERLE-IOLAN-DS1-MIB", "modbusMainUDPStatsPortIndex"))
if mibBuilder.loadTexts: modbusMainUDPStatsEntry.setDescription("An entry in the Modbus/UDP Main statistics table, each relating to a serial port.")
modbusMainUDPStatsPortIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 4, 1, 1), GenericTableIndex()).setMaxAccess("noaccess")
if mibBuilder.loadTexts: modbusMainUDPStatsPortIndex.setDescription("modbusMainUDPStatsPortIndex")
modbusMainUDPStatsSerialMode = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 4, 1, 2), Integer().subtype(subtypeSpec=SingleValueConstraint(0,1,)).subtype(namedValues=NamedValues(("rtu", 0), ("ascii", 1), ))).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainUDPStatsSerialMode.setDescription("Modbus serial device's mode: 0: RTU; 1: ASCII.")
modbusMainUDPStatsSerialFrameErrors = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 4, 1, 3), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainUDPStatsSerialFrameErrors.setDescription("Modbus serial port frame errors")
ioModbusSubordinateStats = MibIdentifier((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 5))
ioModbusSubordinateStatsServiceMode = MibScalar((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 5, 1), OnOffValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ioModbusSubordinateStatsServiceMode.setDescription("Indicates whether I/O Modbus service is active")
ioModbusSubordinateStatsUid = MibScalar((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 5, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 255))).setMaxAccess("readonly")
if mibBuilder.loadTexts: ioModbusSubordinateStatsUid.setDescription("I/O Modbus Subordinate UID")
ioModbusSubordinateStatsCommands = MibScalar((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 5, 3), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ioModbusSubordinateStatsCommands.setDescription("I/O Modbus Subordinate Commands")
ioModbusSubordinateStatsResponses = MibScalar((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 5, 4), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ioModbusSubordinateStatsResponses.setDescription("I/O Modbus Subordinate Responses")
ioModbusSubordinateStatsExceptions = MibScalar((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 5, 5), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ioModbusSubordinateStatsExceptions.setDescription("I/O Modbus Subordinate Exceptions")
modbusSubordinateTCPStatsGatewayTable = MibTable((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 6))
if mibBuilder.loadTexts: modbusSubordinateTCPStatsGatewayTable.setDescription("Modbus TCP Subordinate Gateway Statistics Table.")
modbusSubordinateTCPStatsGatewayEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 6, 1)).setIndexNames((0, "PERLE-IOLAN-DS1-MIB", "modbusSubordinateTCPStatsGatewayPortIndex"), (0, "PERLE-IOLAN-DS1-MIB", "modbusSubordinateTCPStatsGatewayUIDIndex"))
if mibBuilder.loadTexts: modbusSubordinateTCPStatsGatewayEntry.setDescription("An entry in the modbusStatsGatewayTable.")
modbusSubordinateTCPStatsGatewayPortIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 6, 1, 1), GenericTableIndex()).setMaxAccess("noaccess")
if mibBuilder.loadTexts: modbusSubordinateTCPStatsGatewayPortIndex.setDescription("The port number index")
modbusSubordinateTCPStatsGatewayUIDIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 6, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 247))).setMaxAccess("noaccess")
if mibBuilder.loadTexts: modbusSubordinateTCPStatsGatewayUIDIndex.setDescription("The UID index")
modbusSubordinateTCPStatsGatewayRemoteIP = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 6, 1, 3), Ipv4v6Address()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateTCPStatsGatewayRemoteIP.setDescription("The remote subordinate/main IP address.")
modbusSubordinateTCPStatsGatewayUID = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 6, 1, 4), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 247))).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateTCPStatsGatewayUID.setDescription("The UID.")
modbusSubordinateTCPStatsGatewayRemotePortNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 6, 1, 5), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateTCPStatsGatewayRemotePortNumber.setDescription("The remote TCP/UDP port number.")
modbusSubordinateTCPStatsGatewayCommands = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 6, 1, 6), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateTCPStatsGatewayCommands.setDescription("The commands count.")
modbusSubordinateTCPStatsGatewayResponses = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 6, 1, 7), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateTCPStatsGatewayResponses.setDescription("The response count.")
modbusSubordinateTCPStatsGatewayExceptions = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 6, 1, 8), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateTCPStatsGatewayExceptions.setDescription("the exceptions count.")
modbusSubordinateTCPStatsGatewayFrameErrors = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 6, 1, 9), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateTCPStatsGatewayFrameErrors.setDescription("The frame errors count.")
modbusMainTCPStatsGatewayTable = MibTable((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 7))
if mibBuilder.loadTexts: modbusMainTCPStatsGatewayTable.setDescription("Modbus Main TCP Gateway Statistics Table.")
modbusMainTCPStatsGatewayEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 7, 1)).setIndexNames((0, "PERLE-IOLAN-DS1-MIB", "modbusMainTCPStatsGatewayPortIndex"), (0, "PERLE-IOLAN-DS1-MIB", "modbusMainTCPStatsGatewayUIDIndex"))
if mibBuilder.loadTexts: modbusMainTCPStatsGatewayEntry.setDescription("An entry in the modbusStatsGatewayTable.")
modbusMainTCPStatsGatewayPortIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 7, 1, 1), GenericTableIndex()).setMaxAccess("noaccess")
if mibBuilder.loadTexts: modbusMainTCPStatsGatewayPortIndex.setDescription("The port number index")
modbusMainTCPStatsGatewayUIDIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 7, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 247))).setMaxAccess("noaccess")
if mibBuilder.loadTexts: modbusMainTCPStatsGatewayUIDIndex.setDescription("The UID index")
modbusMainTCPStatsGatewayRemoteIP = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 7, 1, 3), Ipv4v6Address()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainTCPStatsGatewayRemoteIP.setDescription("The remote subordinate/main IP address.")
modbusMainTCPStatsGatewayUID = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 7, 1, 4), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 247))).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainTCPStatsGatewayUID.setDescription("The UID.")
modbusMainTCPStatsGatewayRemotePortNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 7, 1, 5), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainTCPStatsGatewayRemotePortNumber.setDescription("the remote TCP/UDP port number.")
modbusMainTCPStatsGatewayCommands = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 7, 1, 6), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainTCPStatsGatewayCommands.setDescription("The commands count.")
modbusMainTCPStatsGatewayResponses = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 7, 1, 7), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainTCPStatsGatewayResponses.setDescription("The response count.")
modbusMainTCPStatsGatewayExceptions = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 7, 1, 8), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainTCPStatsGatewayExceptions.setDescription("The exceptions count.")
modbusMainTCPStatsGatewayFrameErrors = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 7, 1, 9), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainTCPStatsGatewayFrameErrors.setDescription("The frame errors count.")
modbusSubordinateUDPStatsGatewayTable = MibTable((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 8))
if mibBuilder.loadTexts: modbusSubordinateUDPStatsGatewayTable.setDescription("Modbus UDP Subordinate Gateway Statistics Table.")
modbusSubordinateUDPStatsGatewayEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 8, 1)).setIndexNames((0, "PERLE-IOLAN-DS1-MIB", "modbusSubordinateUDPStatsGatewayPortIndex"), (0, "PERLE-IOLAN-DS1-MIB", "modbusSubordinateUDPStatsGatewayUIDIndex"))
if mibBuilder.loadTexts: modbusSubordinateUDPStatsGatewayEntry.setDescription("An entry in the modbusStatsGatewayTable.")
modbusSubordinateUDPStatsGatewayPortIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 8, 1, 1), GenericTableIndex()).setMaxAccess("noaccess")
if mibBuilder.loadTexts: modbusSubordinateUDPStatsGatewayPortIndex.setDescription("The port number index")
modbusSubordinateUDPStatsGatewayUIDIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 8, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 247))).setMaxAccess("noaccess")
if mibBuilder.loadTexts: modbusSubordinateUDPStatsGatewayUIDIndex.setDescription("The UID index")
modbusSubordinateUDPStatsGatewayRemoteIP = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 8, 1, 3), Ipv4v6Address()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateUDPStatsGatewayRemoteIP.setDescription("The remote subordinate/main IP address.")
modbusSubordinateUDPStatsGatewayUID = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 8, 1, 4), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 247))).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateUDPStatsGatewayUID.setDescription("The UID.")
modbusSubordinateUDPStatsGatewayRemotePortNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 8, 1, 5), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateUDPStatsGatewayRemotePortNumber.setDescription("the remote TCP/UDP port number.")
modbusSubordinateUDPStatsGatewayCommands = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 8, 1, 6), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateUDPStatsGatewayCommands.setDescription("The commands count.")
modbusSubordinateUDPStatsGatewayResponses = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 8, 1, 7), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateUDPStatsGatewayResponses.setDescription("The response count.")
modbusSubordinateUDPStatsGatewayExceptions = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 8, 1, 8), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateUDPStatsGatewayExceptions.setDescription("The exceptions count.")
modbusSubordinateUDPStatsGatewayFrameErrors = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 8, 1, 9), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusSubordinateUDPStatsGatewayFrameErrors.setDescription("The frame errors count.")
modbusMainUDPStatsGatewayTable = MibTable((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 9))
if mibBuilder.loadTexts: modbusMainUDPStatsGatewayTable.setDescription("Modbus UDP Main Gateway Statistics Table.")
modbusMainUDPStatsGatewayEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 9, 1)).setIndexNames((0, "PERLE-IOLAN-DS1-MIB", "modbusMainUDPStatsGatewayPortIndex"), (0, "PERLE-IOLAN-DS1-MIB", "modbusMainUDPStatsGatewayUIDIndex"))
if mibBuilder.loadTexts: modbusMainUDPStatsGatewayEntry.setDescription("An entry in the modbusStatsGatewayTable.")
modbusMainUDPStatsGatewayPortIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 9, 1, 1), GenericTableIndex()).setMaxAccess("noaccess")
if mibBuilder.loadTexts: modbusMainUDPStatsGatewayPortIndex.setDescription("The port number index")
modbusMainUDPStatsGatewayUIDIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 9, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 247))).setMaxAccess("noaccess")
if mibBuilder.loadTexts: modbusMainUDPStatsGatewayUIDIndex.setDescription("The UID index")
modbusMainUDPStatsGatewayRemoteIP = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 9, 1, 3), Ipv4v6Address()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainUDPStatsGatewayRemoteIP.setDescription("The remote subordinate/main IP address.")
modbusMainUDPStatsGatewayUID = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 9, 1, 4), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 247))).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainUDPStatsGatewayUID.setDescription("The UID.")
modbusMainUDPStatsGatewayRemotePortNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 9, 1, 5), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainUDPStatsGatewayRemotePortNumber.setDescription("The remote TCP/UDP port number.")
modbusMainUDPStatsGatewayCommands = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 9, 1, 6), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainUDPStatsGatewayCommands.setDescription("The commands count.")
modbusMainUDPStatsGatewayResponses = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 9, 1, 7), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainUDPStatsGatewayResponses.setDescription("The response count.")
modbusMainUDPStatsGatewayExceptions = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 9, 1, 8), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainUDPStatsGatewayExceptions.setDescription("The exceptions count.")
modbusMainUDPStatsGatewayFrameErrors = MibTableColumn((1, 3, 6, 1, 4, 1, 1966, 13, 1, 25, 9, 1, 9), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: modbusMainUDPStatsGatewayFrameErrors.setDescription("The frame errors count.")
...
ds1MIBMainGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 1966, 13, 3, 2, 1)).setObjects(*(("PERLE-IOLAN-DS1-MIB", "defUserTcpClearPort"), ("PERLE-IOLAN-DS1-MIB", "portCustomAppStatus"), ("PERLE-IOLAN-DS1-MIB", "portSendName"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingPacketIdleTime"), ("PERLE-IOLAN-DS1-MIB", "portTelnetMapnl"), ("PERLE-IOLAN-DS1-MIB", "interfacev6PrefixBits"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalInputCfgAlarmTrigger"), ("PERLE-IOLAN-DS1-MIB", "serviceDHCPv6"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalStatusInputAlarm"), ("PERLE-IOLAN-DS1-MIB", "serverGenericWebLoginScreen"), ("PERLE-IOLAN-DS1-MIB", "ethStatsRxDroppedPkts"), ("PERLE-IOLAN-DS1-MIB", "udpConnTxQueueBytes"), ("PERLE-IOLAN-DS1-MIB", "userSessionTelnetQuit"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateUDPStatsGatewayFrameErrors"), ("PERLE-IOLAN-DS1-MIB", "portConnectTerminateString"), ("PERLE-IOLAN-DS1-MIB", "ioModbusSubordinateStatsCommands"), ("PERLE-IOLAN-DS1-MIB", "ioUdpEntryStartAddress"), ("PERLE-IOLAN-DS1-MIB", "modbusMainUDPStatsGatewayResponses"), ("PERLE-IOLAN-DS1-MIB", "ioRelayCfgStatus"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalInputCfgAlarmTrigger"), ("PERLE-IOLAN-DS1-MIB", "trueport75"), ("PERLE-IOLAN-DS1-MIB", "ioModbusSubordinateStatsServiceMode"), ("PERLE-IOLAN-DS1-MIB", "defUserPortRIAccessAllowed"), ("PERLE-IOLAN-DS1-MIB", "ioRelayExtCfgLinkChannel"), ("PERLE-IOLAN-DS1-MIB", "ioRelayExtCfgConnMethod"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsFragFails"), ("PERLE-IOLAN-DS1-MIB", "portDialTimeout"), ("PERLE-IOLAN-DS1-MIB", "ioRelayMultihostStatus"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateUDPStatsSerialFrameErrors"), ("PERLE-IOLAN-DS1-MIB", "ethStatsTxCarrierErrs"), ("PERLE-IOLAN-DS1-MIB", "portModem"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingEndTrigger1"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingEndTrigger2"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxGroupMembResponses"), ("PERLE-IOLAN-DS1-MIB", "snmpReadWriteUser"), ("PERLE-IOLAN-DS1-MIB", "udpConnv6State"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalFunction"), ("PERLE-IOLAN-DS1-MIB", "ioRelayCfgDescription"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxGroupMembReductions"), ("PERLE-IOLAN-DS1-MIB", "tcpConnv6LocalPort"), ("PERLE-IOLAN-DS1-MIB", "portBreakLength"), ("PERLE-IOLAN-DS1-MIB", "tcpConnTxQueueBytes"), ("PERLE-IOLAN-DS1-MIB", "serviceStatus"), ("PERLE-IOLAN-DS1-MIB", "portTelnetEchoCC"), ("PERLE-IOLAN-DS1-MIB", "portMOTD"), ("PERLE-IOLAN-DS1-MIB", "modbusMainUDPStatsGatewayExceptions"), ("PERLE-IOLAN-DS1-MIB", "ioLineExtSigCfgConnMethod"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalStatusType"), ("PERLE-IOLAN-DS1-MIB", "portMODBUSMainMappingUIDRangeMode"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalCfgResourceType"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsTxMcastPkts"), ("PERLE-IOLAN-DS1-MIB", "syslogPrimaryHost"), ("PERLE-IOLAN-DS1-MIB", "icmpV6RxGroupMembResponses"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsReasmTimeout"), ("PERLE-IOLAN-DS1-MIB", "portHdwDSR"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsTxDiscards"), ("PERLE-IOLAN-DS1-MIB", "trueportStatus"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingPacketSize"), ("PERLE-IOLAN-DS1-MIB", "ioRelayStatusState"), ("PERLE-IOLAN-DS1-MIB", "portDataLogging"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogStatusEnabled"), ("PERLE-IOLAN-DS1-MIB", "udpConnv6RxQueueBytes"), ("PERLE-IOLAN-DS1-MIB", "portHdwDTR"), ("PERLE-IOLAN-DS1-MIB", "trueportCustom1800"), ("PERLE-IOLAN-DS1-MIB", "portMODBUSMainMappingRemoteIP"), ("PERLE-IOLAN-DS1-MIB", "portCustomAppCommand"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsRxAddrErrors"), ("PERLE-IOLAN-DS1-MIB", "gatewayType"), ("PERLE-IOLAN-DS1-MIB", "portTelnetStatus"), ("PERLE-IOLAN-DS1-MIB", "portMODBUSMainCRLF"), ("PERLE-IOLAN-DS1-MIB", "ethStatsLocalAddress"), ("PERLE-IOLAN-DS1-MIB", "portVmodemPort"), ("PERLE-IOLAN-DS1-MIB", "fileConfigurationHost"), ("PERLE-IOLAN-DS1-MIB", "defUserIpHost"), ("PERLE-IOLAN-DS1-MIB", "portVmodemSuppress"), ("PERLE-IOLAN-DS1-MIB", "serviceSyslog"), ("PERLE-IOLAN-DS1-MIB", "serverBypassPassword"), ("PERLE-IOLAN-DS1-MIB", "serverDisplayMotdWeb"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalInputCfgInvertSignal"), ("PERLE-IOLAN-DS1-MIB", "userIdleTime"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalCfgStatus"), ("PERLE-IOLAN-DS1-MIB", "ioRelayExtCfgHost"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsTxNoRoutes"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsRxDelivers"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogCfgType"), ("PERLE-IOLAN-DS1-MIB", "ipv6AddressPrefixBits"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateTCPStatsGatewayRemotePortNumber"), ("PERLE-IOLAN-DS1-MIB", "portTelnetPort"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingEnableSOF2"), ("PERLE-IOLAN-DS1-MIB", "portHdwIRQ"), ("PERLE-IOLAN-DS1-MIB", "tcpConnRemotePort"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalExtCfgPort"), ("PERLE-IOLAN-DS1-MIB", "serverEth0MTU"), ("PERLE-IOLAN-DS1-MIB", "ioRelayFunction"), ("PERLE-IOLAN-DS1-MIB", "portSessionTimer"), ("PERLE-IOLAN-DS1-MIB", "defUserHost"), ("PERLE-IOLAN-DS1-MIB", "trueport50"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateTCPStatsSerialFrameErrors"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsRxMcastPkts"), ("PERLE-IOLAN-DS1-MIB", "udpV6TxDatagrams"), ("PERLE-IOLAN-DS1-MIB", "portDirectTrigger"), ("PERLE-IOLAN-DS1-MIB", "ioTrueportEnable"), ("PERLE-IOLAN-DS1-MIB", "portPreDefinedUser"), ("PERLE-IOLAN-DS1-MIB", "modbusMainTCPStatsGatewayRemotePortNumber"), ("PERLE-IOLAN-DS1-MIB", "serverBanner"), ("PERLE-IOLAN-DS1-MIB", "portVmodemEcho"), ("PERLE-IOLAN-DS1-MIB", "defUserLanguage"), ("PERLE-IOLAN-DS1-MIB", "modbusMainUDPStatsGatewayUID"), ("PERLE-IOLAN-DS1-MIB", "modbusGatewayConnIdleTimeout"), ("PERLE-IOLAN-DS1-MIB", "ioUdpEntryEndAddress"), ("PERLE-IOLAN-DS1-MIB", "portHdwFlowControl"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalCfgEnable"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalStatusDescription"), ("PERLE-IOLAN-DS1-MIB", "portRIAccessAllowed"), ("PERLE-IOLAN-DS1-MIB", "portHdwCD"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalStatusLatchedInputState"), ("PERLE-IOLAN-DS1-MIB", "portHdwFrameErrs"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogStatusAlarmLevel"), ("PERLE-IOLAN-DS1-MIB", "serviceDeviceManagerD"), ("PERLE-IOLAN-DS1-MIB", "defUserPortAccessStatus"), ("PERLE-IOLAN-DS1-MIB", "interfacev6Scope"), ("PERLE-IOLAN-DS1-MIB", "portDSPort"), ("PERLE-IOLAN-DS1-MIB", "portHdwRTS"), ("PERLE-IOLAN-DS1-MIB", "ethStatsMainLoadBalancer"), ("PERLE-IOLAN-DS1-MIB", "userSessionTelnetHost"), ("PERLE-IOLAN-DS1-MIB", "serverIPaddress"), ("PERLE-IOLAN-DS1-MIB", "tcpConnRemoteAddress"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogCfgThermRange"), ("PERLE-IOLAN-DS1-MIB", "portVmodemSuccessString"), ("PERLE-IOLAN-DS1-MIB", "ethStatsCollisions"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalMultihostStatus"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingEnableEOF1"), ("PERLE-IOLAN-DS1-MIB", "ethStatsLoopback"), ("PERLE-IOLAN-DS1-MIB", "portVmodemRTS"), ("PERLE-IOLAN-DS1-MIB", "portMultihostOutboundHostID"), ("PERLE-IOLAN-DS1-MIB", "ethStatsMtu"), ("PERLE-IOLAN-DS1-MIB", "customAppServerStatus"), ("PERLE-IOLAN-DS1-MIB", "snmpReadOnlyUser"), ("PERLE-IOLAN-DS1-MIB", "portTunnelPort"), ("PERLE-IOLAN-DS1-MIB", "portBreakDelay"), ("PERLE-IOLAN-DS1-MIB", "ethStatsStatus"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsFragCreates"), ("PERLE-IOLAN-DS1-MIB", "portTrueportServiceHost"), ("PERLE-IOLAN-DS1-MIB", "modbusGatewayException"), ("PERLE-IOLAN-DS1-MIB", "ethStatsSetMedia"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingEnableEOF2"), ("PERLE-IOLAN-DS1-MIB", "udpConnv6LocalAddress"), ("PERLE-IOLAN-DS1-MIB", "userSessionTelnetEOF"), ("PERLE-IOLAN-DS1-MIB", "gatewaySubnetBits"), ("PERLE-IOLAN-DS1-MIB", "routev6Interface"), ("PERLE-IOLAN-DS1-MIB", "udpConnLocalAddress"), ("PERLE-IOLAN-DS1-MIB", "routev6Destination"), ("PERLE-IOLAN-DS1-MIB", "portMODBUSMainMappingUIDStart"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingStartFrameTransmit"), ("PERLE-IOLAN-DS1-MIB", "serverDropSessionDetectionTime"), ("PERLE-IOLAN-DS1-MIB", "ioModbusUid"), ("PERLE-IOLAN-DS1-MIB", "ioUdpEnable"), ("PERLE-IOLAN-DS1-MIB", "userSessionTelnetBreak"), ("PERLE-IOLAN-DS1-MIB", "ioRelayCfgEnable"), ("PERLE-IOLAN-DS1-MIB", "ioLineExtSigCfgEnable"), ("PERLE-IOLAN-DS1-MIB", "modbusMainUDPStatsSerialFrameErrors"), ("PERLE-IOLAN-DS1-MIB", "fileStatus"), ("PERLE-IOLAN-DS1-MIB", "udpV6RxErrors"), ("PERLE-IOLAN-DS1-MIB", "ethStatsPromiscuous"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalStatusState"), ("PERLE-IOLAN-DS1-MIB", "userHotKeyPrefix"), ("PERLE-IOLAN-DS1-MIB", "snmpLocation"), ("PERLE-IOLAN-DS1-MIB", "userSessionTime"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateUDPStatsSerialMode"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogStatusMinimum"), ("PERLE-IOLAN-DS1-MIB", "portMultihostOutboundStatus"), ("PERLE-IOLAN-DS1-MIB", "modbusGatewayRemappedUID"), ("PERLE-IOLAN-DS1-MIB", "modbusMainUDPStatsGatewayRemoteIP"), ("PERLE-IOLAN-DS1-MIB", "portTrueportServiceActiveSignal"), ("PERLE-IOLAN-DS1-MIB", "ethStatsTxDroppedPkts"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogCfgAlarmEnable"), ("PERLE-IOLAN-DS1-MIB", "defUserPortROAccessAllowed"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalCfgDescription"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalInputCfgLatch"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsRxUnknownProtos"), ("PERLE-IOLAN-DS1-MIB", "udpConnState"), ("PERLE-IOLAN-DS1-MIB", "userSessionTelnetErase"), ("PERLE-IOLAN-DS1-MIB", "trueportCustom200"), ("PERLE-IOLAN-DS1-MIB", "modbusMainTCPStatsGatewayUID"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogCfgAlarmSyslog"), ("PERLE-IOLAN-DS1-MIB", "modbusMainTCPStatsSerialMode"), ("PERLE-IOLAN-DS1-MIB", "portMODBUSMainMappingTransportType"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateTCPStatsSerialMode"), ("PERLE-IOLAN-DS1-MIB", "portConnectInitiateString"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateTCPStatsGatewayFrameErrors"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalInputCfgAlarmSyslog"), ("PERLE-IOLAN-DS1-MIB", "icmpV6RxRedirects"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsReasmReqds"), ("PERLE-IOLAN-DS1-MIB", "tcpConnv6LocalAddress"), ("PERLE-IOLAN-DS1-MIB", "portSecurity"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogCfgAlarmSNMP"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingEOF1"), ("PERLE-IOLAN-DS1-MIB", "udpConnv6TxQueueBytes"), ("PERLE-IOLAN-DS1-MIB", "serverName"), ("PERLE-IOLAN-DS1-MIB", "portOutboundFlowControl"), ("PERLE-IOLAN-DS1-MIB", "userSessionStatus"), ("PERLE-IOLAN-DS1-MIB", "portHdwRxBytes"), ("PERLE-IOLAN-DS1-MIB", "ethStatsDynamic"), ("PERLE-IOLAN-DS1-MIB", "userIdleTimer"), ("PERLE-IOLAN-DS1-MIB", "serverPasswordLimit"), ("PERLE-IOLAN-DS1-MIB", "serverTFTPTimeOut"), ("PERLE-IOLAN-DS1-MIB", "customAppServerCommand"), ("PERLE-IOLAN-DS1-MIB", "trueport600"), ("PERLE-IOLAN-DS1-MIB", "ioLineMultihostSigStatus"), ("PERLE-IOLAN-DS1-MIB", "snmpCommunityPermission"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalStatusExtensionState"), ("PERLE-IOLAN-DS1-MIB", "portHdwStatus"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalStatusInputAlarm"), ("PERLE-IOLAN-DS1-MIB", "snmpCommunityIpAddress"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalInputCfgAlarmClear"), ("PERLE-IOLAN-DS1-MIB", "ioRelayStatusEnabled"), ("PERLE-IOLAN-DS1-MIB", "ioModbusSubordinateStatsExceptions"), ("PERLE-IOLAN-DS1-MIB", "udpConnv6LocalPort"), ("PERLE-IOLAN-DS1-MIB", "serviceDHCP"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingEnableEndTrigger1"), ("PERLE-IOLAN-DS1-MIB", "trueport4800"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingEnableEndTrigger2"), ("PERLE-IOLAN-DS1-MIB", "udpConnRemoteAddress"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingForceTransmitTime"), ("PERLE-IOLAN-DS1-MIB", "ipv6AddressSendAdvertise"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalStatusLatchedInputState"), ("PERLE-IOLAN-DS1-MIB", "portHdwDuplex"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalFunction"), ("PERLE-IOLAN-DS1-MIB", "ioModbusSubordinateStatsUid"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateUDPStatsGatewayUID"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogStatusValue"), ("PERLE-IOLAN-DS1-MIB", "trueport300"), ("PERLE-IOLAN-DS1-MIB", "fileFirmwareName"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalOutputCfgPulseMode"), ("PERLE-IOLAN-DS1-MIB", "ioRelayStatusExtensionState"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalExtCfgKeepalive"), ("PERLE-IOLAN-DS1-MIB", "modbusMainTCPStatsGatewayRemoteIP"), ("PERLE-IOLAN-DS1-MIB", "syslogLevel"), ("PERLE-IOLAN-DS1-MIB", "serviceTelnetD"), ("PERLE-IOLAN-DS1-MIB", "portVmodemDCD"), ("PERLE-IOLAN-DS1-MIB", "portMODBUSMainMode"), ("PERLE-IOLAN-DS1-MIB", "portUDPOption"), ("PERLE-IOLAN-DS1-MIB", "ioRelayCfgPulseCount"), ("PERLE-IOLAN-DS1-MIB", "ioRelayExtCfgKeepalive"), ("PERLE-IOLAN-DS1-MIB", "trueportCustom50"), ("PERLE-IOLAN-DS1-MIB", "adminFunction"), ("PERLE-IOLAN-DS1-MIB", "portAccessStatus"), ("PERLE-IOLAN-DS1-MIB", "ioLineExtSigCfgStatus"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateUDPStatsGatewayRemotePortNumber"), ("PERLE-IOLAN-DS1-MIB", "trueportCustom134"), ("PERLE-IOLAN-DS1-MIB", "ioRelayExtCfgStatus"), ("PERLE-IOLAN-DS1-MIB", "tcpConnRxQueueBytes"), ("PERLE-IOLAN-DS1-MIB", "ethStatsRxErrors"), ("PERLE-IOLAN-DS1-MIB", "ioLineMultihostModeSig"), ("PERLE-IOLAN-DS1-MIB", "ioRelayCfgMode"), ("PERLE-IOLAN-DS1-MIB", "portUDPStatus"), ("PERLE-IOLAN-DS1-MIB", "modbusMainTCPStatsGatewayResponses"), ("PERLE-IOLAN-DS1-MIB", "portHdwDataBits"), ("PERLE-IOLAN-DS1-MIB", "ethStatsTxPackets"), ("PERLE-IOLAN-DS1-MIB", "ethStatsMulticast"), ("PERLE-IOLAN-DS1-MIB", "portTrueportServicePort"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogCfgRtdRange"), ("PERLE-IOLAN-DS1-MIB", "portTelnetTermType"), ("PERLE-IOLAN-DS1-MIB", "serverSingleTelnet"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateUDPStatsGatewayResponses"), ("PERLE-IOLAN-DS1-MIB", "trueportCustom1200"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsRxTotalPkts"), ("PERLE-IOLAN-DS1-MIB", "modbusMainUDPStatsGatewayRemotePortNumber"), ("PERLE-IOLAN-DS1-MIB", "trueport150"), ("PERLE-IOLAN-DS1-MIB", "portBreak"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateTCPStatsGatewayCommands"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalOutputCfgActiveSignalWidth"), ("PERLE-IOLAN-DS1-MIB", "portReset"), ("PERLE-IOLAN-DS1-MIB", "ipv6AddressStatus"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxEchos"), ("PERLE-IOLAN-DS1-MIB", "tcpConnLocalPort"), ("PERLE-IOLAN-DS1-MIB", "udpConnLocalPort"), ("PERLE-IOLAN-DS1-MIB", "icmpV6RxParmProblems"), ("PERLE-IOLAN-DS1-MIB", "ioFailsafeTimeout"), ("PERLE-IOLAN-DS1-MIB", "ethStatsRxBytes"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateUDPStatsGatewayExceptions"), ("PERLE-IOLAN-DS1-MIB", "snmpCommunityStatus"), ("PERLE-IOLAN-DS1-MIB", "ioRelayCfgFailsafe"), ("PERLE-IOLAN-DS1-MIB", "ioModbusEnable"), ("PERLE-IOLAN-DS1-MIB", "icmpV6RxTimeExcds"), ("PERLE-IOLAN-DS1-MIB", "defUserStatus"), ("PERLE-IOLAN-DS1-MIB", "userService"), ("PERLE-IOLAN-DS1-MIB", "udpConnv6RemotePort"), ("PERLE-IOLAN-DS1-MIB", "portMODBUSMainMappingUIDEnd"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalStatusExtensionState"), ("PERLE-IOLAN-DS1-MIB", "tcpConnv6State"), ("PERLE-IOLAN-DS1-MIB", "icmpV6RxNeighborSolicits"), ("PERLE-IOLAN-DS1-MIB", "portTelnetEcho"), ("PERLE-IOLAN-DS1-MIB", "userSessionAuto"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingIdleTime"), ("PERLE-IOLAN-DS1-MIB", "userSessionType"), ("PERLE-IOLAN-DS1-MIB", "ioUdpEntryPort"), ("PERLE-IOLAN-DS1-MIB", "portIdleTimer"), ("PERLE-IOLAN-DS1-MIB", "portMODBUSMainMappingPortNumber"), ("PERLE-IOLAN-DS1-MIB", "portTelnetQuit"), ("PERLE-IOLAN-DS1-MIB", "portService"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalInputCfgAlarmSNMP"), ("PERLE-IOLAN-DS1-MIB", "portDialRetries"), ("PERLE-IOLAN-DS1-MIB", "portVmodemHost"), ("PERLE-IOLAN-DS1-MIB", "portVmodemResponseDelay"), ("PERLE-IOLAN-DS1-MIB", "modbusGatewayQueuing"), ("PERLE-IOLAN-DS1-MIB", "userLanguage"), ("PERLE-IOLAN-DS1-MIB", "userSessionTelnetTermType"), ("PERLE-IOLAN-DS1-MIB", "ioUdpEntryEnable"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingSOF1"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingSOF2"), ("PERLE-IOLAN-DS1-MIB", "serverOemLogin"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsRxTooBigErrors"), ("PERLE-IOLAN-DS1-MIB", "ioLineExtSigCfgHost"), ("PERLE-IOLAN-DS1-MIB", "userSessionTelnetMapnl"), ("PERLE-IOLAN-DS1-MIB", "modbusMainUDPStatsGatewayFrameErrors"), ("PERLE-IOLAN-DS1-MIB", "ethStatsSubnetMask"), ("PERLE-IOLAN-DS1-MIB", "ethStatsTxBytes"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingForwardMode"), ("PERLE-IOLAN-DS1-MIB", "trueportCustom75"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalInputCfgAlarmSyslog"), ("PERLE-IOLAN-DS1-MIB", "portTelnetHost"), ("PERLE-IOLAN-DS1-MIB", "ioRelayExtCfgEnable"), ("PERLE-IOLAN-DS1-MIB", "portRawPort"), ("PERLE-IOLAN-DS1-MIB", "modbusGatewayMessageTimeout"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalExtCfgMultiHost"), ("PERLE-IOLAN-DS1-MIB", "serviceMODBUSD"), ("PERLE-IOLAN-DS1-MIB", "ioLineExtSigCfgPort"), ("PERLE-IOLAN-DS1-MIB", "ioTrueportTcpListenPort"), ("PERLE-IOLAN-DS1-MIB", "portHotKeyPrefix"), ("PERLE-IOLAN-DS1-MIB", "portTelnetEOF"), ("PERLE-IOLAN-DS1-MIB", "ioLineMultihostOutboundSigStatus"), ("PERLE-IOLAN-DS1-MIB", "portLock"), ("PERLE-IOLAN-DS1-MIB", "ethStatsRxPackets"), ("PERLE-IOLAN-DS1-MIB", "snmpContact"), ("PERLE-IOLAN-DS1-MIB", "portTrueportServiceClientInitiated"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalInputCfgAlarmSNMP"), ("PERLE-IOLAN-DS1-MIB", "tcpConnv6RxQueueBytes"), ("PERLE-IOLAN-DS1-MIB", "vmodemPhone"), ("PERLE-IOLAN-DS1-MIB", "trueport134"), ("PERLE-IOLAN-DS1-MIB", "portHdwBreaks"), ("PERLE-IOLAN-DS1-MIB", "ioModbusSubordinateStatsResponses"), ("PERLE-IOLAN-DS1-MIB", "modbusGatewayBroadcast"), ("PERLE-IOLAN-DS1-MIB", "userSessionTelnetEcho"), ("PERLE-IOLAN-DS1-MIB", "portInitialMode"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalInputCfgInvertSignal"), ("PERLE-IOLAN-DS1-MIB", "portHdwEchoSuppression"), ("PERLE-IOLAN-DS1-MIB", "portTunnelHost"), ("PERLE-IOLAN-DS1-MIB", "serverTFTPRetry"), ("PERLE-IOLAN-DS1-MIB", "interfacev6Address"), ("PERLE-IOLAN-DS1-MIB", "adminSystemDate"), ("PERLE-IOLAN-DS1-MIB", "vmodemPhoneIP"), ("PERLE-IOLAN-DS1-MIB", "ioRelayMultihostOutboundHostID"), ("PERLE-IOLAN-DS1-MIB", "ethStatsRxMulticast"), ("PERLE-IOLAN-DS1-MIB", "serverDataLoggingOptions"), ("PERLE-IOLAN-DS1-MIB", "portHdwStopBits"), ("PERLE-IOLAN-DS1-MIB", "tcpConnv6RemoteAddress"), ("PERLE-IOLAN-DS1-MIB", "ioRelayCfgActiveSignalWidth"), ("PERLE-IOLAN-DS1-MIB", "portMODBUSMainStatus"), ("PERLE-IOLAN-DS1-MIB", "serverKeepAliveTimeout"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsFragOKs"), ("PERLE-IOLAN-DS1-MIB", "ipv6AddressAddr"), ("PERLE-IOLAN-DS1-MIB", "portHdwDiscardCharactersRecievedWithErrors"), ("PERLE-IOLAN-DS1-MIB", "portBidirHost"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxEchoReplies"), ("PERLE-IOLAN-DS1-MIB", "vmodemPhoneStatus"), ("PERLE-IOLAN-DS1-MIB", "serviceDHCPv6IPAddresses"), ("PERLE-IOLAN-DS1-MIB", "portVmodemFailureString"), ("PERLE-IOLAN-DS1-MIB", "portVmodemStatus"), ("PERLE-IOLAN-DS1-MIB", "defUserTelnetPort"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsReasmFails"), ("PERLE-IOLAN-DS1-MIB", "ioGlobalCfgStatus"), ("PERLE-IOLAN-DS1-MIB", "ipv6AddressAuto"), ("PERLE-IOLAN-DS1-MIB", "serverDomainName"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxNeighborSolicits"), ("PERLE-IOLAN-DS1-MIB", "icmpV6RxNeighborAdvertisements"), ("PERLE-IOLAN-DS1-MIB", "defUserSessionTimer"), ("PERLE-IOLAN-DS1-MIB", "portMODBUSSubordinateUIDRange"), ("PERLE-IOLAN-DS1-MIB", "portRawOption"), ("PERLE-IOLAN-DS1-MIB", "serverEth1MTU"), ("PERLE-IOLAN-DS1-MIB", "serviceDHCPv6NetworkPrefix"), ("PERLE-IOLAN-DS1-MIB", "defUserIdleTimer"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateTCPStatsGatewayRemoteIP"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalMultihostMode"), ("PERLE-IOLAN-DS1-MIB", "ioUdpBroadcastInterval"), ("PERLE-IOLAN-DS1-MIB", "ethStatsAutoMedia"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsRxNoRoutes"), ("PERLE-IOLAN-DS1-MIB", "snmpTrapIpAddress"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalCfgDescription"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalInputCfgAlarmClear"), ("PERLE-IOLAN-DS1-MIB", "icmpV6RxMsgs"), ("PERLE-IOLAN-DS1-MIB", "icmpV6RxEchoReplies"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogCfgAlarmTriggerLevel"), ("PERLE-IOLAN-DS1-MIB", "fileConfigurationName"), ("PERLE-IOLAN-DS1-MIB", "syslogStatus"), ("PERLE-IOLAN-DS1-MIB", "trueport1800"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalOutputCfgPulseCount"), ("PERLE-IOLAN-DS1-MIB", "portTunnelStatus"), ("PERLE-IOLAN-DS1-MIB", "portVmodemMode"), ("PERLE-IOLAN-DS1-MIB", "portVmodemStyle"), ("PERLE-IOLAN-DS1-MIB", "adminStatus"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateUDPStatsGatewayCommands"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateUDPStatsGatewayRemoteIP"), ("PERLE-IOLAN-DS1-MIB", "ethStatsTxPktErrors"), ("PERLE-IOLAN-DS1-MIB", "serverEthernetSpeedDuplex"), ("PERLE-IOLAN-DS1-MIB", "routev6Flags"), ("PERLE-IOLAN-DS1-MIB", "trueportCustom38400"), ("PERLE-IOLAN-DS1-MIB", "ipv6serviceStatus"), ("PERLE-IOLAN-DS1-MIB", "defUserHotKeyPrefix"), ("PERLE-IOLAN-DS1-MIB", "portHdwParityErrs"), ("PERLE-IOLAN-DS1-MIB", "tcpConnLocalAddress"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingStatus"), ("PERLE-IOLAN-DS1-MIB", "portHdwInterface"), ("PERLE-IOLAN-DS1-MIB", "portUDPEndAddress"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogStatusInputState"), ("PERLE-IOLAN-DS1-MIB", "portTelnetErase"), ("PERLE-IOLAN-DS1-MIB", "portInternetAddress"), ("PERLE-IOLAN-DS1-MIB", "fileFirmwareHost"), ("PERLE-IOLAN-DS1-MIB", "portMODBUSSubordinateStatus"), ("PERLE-IOLAN-DS1-MIB", "portMODBUSSubordinateCRLF"), ("PERLE-IOLAN-DS1-MIB", "portTelnetMode"), ("PERLE-IOLAN-DS1-MIB", "udpConnRemotePort"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogCfgAlarmClearMode"), ("PERLE-IOLAN-DS1-MIB", "portDial"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalCfgEnable"), ("PERLE-IOLAN-DS1-MIB", "trueport1200"), ("PERLE-IOLAN-DS1-MIB", "adminKillLine"), ("PERLE-IOLAN-DS1-MIB", "trueportCustom9600"), ("PERLE-IOLAN-DS1-MIB", "adminLastFunction"), ("PERLE-IOLAN-DS1-MIB", "hostIpAddr"), ("PERLE-IOLAN-DS1-MIB", "trueport2400"), ("PERLE-IOLAN-DS1-MIB", "ioChannelFunction"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalMultihostOutboundStatus"), ("PERLE-IOLAN-DS1-MIB", "ethStatsRxOverruns"), ("PERLE-IOLAN-DS1-MIB", "portHdwUART"), ("PERLE-IOLAN-DS1-MIB", "icmpV6RxDestUnreachs"), ("PERLE-IOLAN-DS1-MIB", "portPages"), ("PERLE-IOLAN-DS1-MIB", "portMODBUSSubordinateMode"), ("PERLE-IOLAN-DS1-MIB", "serverSubnetBits"), ("PERLE-IOLAN-DS1-MIB", "modbusGatewayPortNumber"), ("PERLE-IOLAN-DS1-MIB", "ethStatsRxFrameErrs"), ("PERLE-IOLAN-DS1-MIB", "trueportCustom150"), ("PERLE-IOLAN-DS1-MIB", "portStatus"), ("PERLE-IOLAN-DS1-MIB", "portHdwRI"), ("PERLE-IOLAN-DS1-MIB", "modbusGatewayNextRequestDelay"), ("PERLE-IOLAN-DS1-MIB", "ioRelayMultihostMode"), ("PERLE-IOLAN-DS1-MIB", "modbusMainTCPStatsGatewayCommands"), ("PERLE-IOLAN-DS1-MIB", "userPortConnected"), ("PERLE-IOLAN-DS1-MIB", "trueport200"), ("PERLE-IOLAN-DS1-MIB", "userSessionTelnetMode"), ("PERLE-IOLAN-DS1-MIB", "trueport9600"), ("PERLE-IOLAN-DS1-MIB", "userIpHost"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxErrors"), ("PERLE-IOLAN-DS1-MIB", "interfacev6Name"), ("PERLE-IOLAN-DS1-MIB", "trueport19200"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalMultihostOutboundTcpPort"), ("PERLE-IOLAN-DS1-MIB", "ioTemperatureScale"), ("PERLE-IOLAN-DS1-MIB", "ioRelayMultihostOutboundTcpPort"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsRxTruncatedPkts"), ("PERLE-IOLAN-DS1-MIB", "snmpStatus"), ("PERLE-IOLAN-DS1-MIB", "portRWAccessAllowed"), ("PERLE-IOLAN-DS1-MIB", "serverDataLoggingBufferSize"), ("PERLE-IOLAN-DS1-MIB", "ioRelayCfgInactiveSignalWidth"), ("PERLE-IOLAN-DS1-MIB", "icmpV6RxGroupMembReductions"), ("PERLE-IOLAN-DS1-MIB", "syslogSecondaryHost"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateTCPStatsGatewayExceptions"), ("PERLE-IOLAN-DS1-MIB", "modbusMainTCPStatsGatewayExceptions"), ("PERLE-IOLAN-DS1-MIB", "ioRelayStatusDescription"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogCfgVoltageRange"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalOutputCfgFailsafe"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalMultihostOutboundHostID"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogCfgAlarmTrigger"), ("PERLE-IOLAN-DS1-MIB", "modemStatus"), ("PERLE-IOLAN-DS1-MIB", "ethStatsRunning"), ("PERLE-IOLAN-DS1-MIB", "modbusMainTCPStatsSerialFrameErrors"), ("PERLE-IOLAN-DS1-MIB", "adminSystemTime"), ("PERLE-IOLAN-DS1-MIB", "serviceHTTPD"), ("PERLE-IOLAN-DS1-MIB", "ethStatsSubordinateLoadBalancer"), ("PERLE-IOLAN-DS1-MIB", "portTrueportServiceStatus"), ("PERLE-IOLAN-DS1-MIB", "fileMOTDHost"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingForwardingRule"), ("PERLE-IOLAN-DS1-MIB", "ethStatsName"), ("PERLE-IOLAN-DS1-MIB", "ioLineMultihostOutboundSigHostID"), ("PERLE-IOLAN-DS1-MIB", "userHost"), ("PERLE-IOLAN-DS1-MIB", "vmodemPhoneHostName"), ("PERLE-IOLAN-DS1-MIB", "portRawHost"), ("PERLE-IOLAN-DS1-MIB", "trueportCustom300"), ("PERLE-IOLAN-DS1-MIB", "hostName"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingEOF2"), ("PERLE-IOLAN-DS1-MIB", "vmodemPhonePort"), ("PERLE-IOLAN-DS1-MIB", "serverKeepAliveRetries"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalStatusState"), ("PERLE-IOLAN-DS1-MIB", "ethStatsBroadcast"), ("PERLE-IOLAN-DS1-MIB", "ioLineExtSigCfgKeepalive"), ("PERLE-IOLAN-DS1-MIB", "portBidirPort"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalCfgResourceType"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxPktTooBigs"), ("PERLE-IOLAN-DS1-MIB", "tcpConnState"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxRedirects"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalExtCfgHost"), ("PERLE-IOLAN-DS1-MIB", "modemInitialisation"), ("PERLE-IOLAN-DS1-MIB", "portHdwCTS"), ("PERLE-IOLAN-DS1-MIB", "snmpTrapStatus"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogCfgDescription"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalStatusDescription"), ("PERLE-IOLAN-DS1-MIB", "trueportCustom4800"), ("PERLE-IOLAN-DS1-MIB", "modbusGatewayStatus"), ("PERLE-IOLAN-DS1-MIB", "icmpV6RxRouterSolicits"), ("PERLE-IOLAN-DS1-MIB", "portKeepalive"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalOutputCfgInactiveSignalWidth"), ("PERLE-IOLAN-DS1-MIB", "userStatus"), ("PERLE-IOLAN-DS1-MIB", "serverPromptWithName"), ("PERLE-IOLAN-DS1-MIB", "modbusMainTCPStatsGatewayFrameErrors"), ("PERLE-IOLAN-DS1-MIB", "portTelnetBreak"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalExtCfgStatus"), ("PERLE-IOLAN-DS1-MIB", "gatewayHost"), ("PERLE-IOLAN-DS1-MIB", "gatewayStatus"), ("PERLE-IOLAN-DS1-MIB", "ethStatsNoArp"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogCfgAlarmClearLevel"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogStatusDescription"), ("PERLE-IOLAN-DS1-MIB", "snmpTrapName"), ("PERLE-IOLAN-DS1-MIB", "ioRelayExtCfgMultiHost"), ("PERLE-IOLAN-DS1-MIB", "portMODBUSMainMappingStatus"), ("PERLE-IOLAN-DS1-MIB", "serverFlushOnClose"), ("PERLE-IOLAN-DS1-MIB", "trueport38400"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogCfgEnable"), ("PERLE-IOLAN-DS1-MIB", "portMultihostStatus"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogFunction"), ("PERLE-IOLAN-DS1-MIB", "portHdwSpeed"), ("PERLE-IOLAN-DS1-MIB", "serviceSPCD"), ("PERLE-IOLAN-DS1-MIB", "trueportCustom600"), ("PERLE-IOLAN-DS1-MIB", "portUDPPort"), ("PERLE-IOLAN-DS1-MIB", "portHdwMonitorDSR"), ("PERLE-IOLAN-DS1-MIB", "defUserLevel"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxRouterAdvertisements"), ("PERLE-IOLAN-DS1-MIB", "icmpV6RxPktTooBigs"), ("PERLE-IOLAN-DS1-MIB", "trueportCustom2400"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxNeighborAdvertisements"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalOutputCfgFailsafe"), ("PERLE-IOLAN-DS1-MIB", "trueport110"), ("PERLE-IOLAN-DS1-MIB", "trueportCustom19200"), ("PERLE-IOLAN-DS1-MIB", "ioLineExtSigCfgLinkChannel"), ("PERLE-IOLAN-DS1-MIB", "userSessionTelnetInterrupt"), ("PERLE-IOLAN-DS1-MIB", "udpConnRxQueueBytes"), ("PERLE-IOLAN-DS1-MIB", "ethStatsBroadcastAddress"), ("PERLE-IOLAN-DS1-MIB", "portMultihostMode"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogCfgStatus"), ("PERLE-IOLAN-DS1-MIB", "modbusMainUDPStatsGatewayCommands"), ("PERLE-IOLAN-DS1-MIB", "portHdwMonitorDCD"), ("PERLE-IOLAN-DS1-MIB", "portTermType"), ("PERLE-IOLAN-DS1-MIB", "ethStatsTxOverruns"), ("PERLE-IOLAN-DS1-MIB", "portRawStatus"), ("PERLE-IOLAN-DS1-MIB", "portPacketForwardingEnableSOF1"), ("PERLE-IOLAN-DS1-MIB", "routev6Gateway"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxRouterSolicits"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogCfgCurrentRange"), ("PERLE-IOLAN-DS1-MIB", "defUserService"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateTCPStatsGatewayUID"), ("PERLE-IOLAN-DS1-MIB", "ioRelayExtCfgPort"), ("PERLE-IOLAN-DS1-MIB", "routev6PrefixBits"), ("PERLE-IOLAN-DS1-MIB", "fileMOTDName"), ("PERLE-IOLAN-DS1-MIB", "userLevel"), ("PERLE-IOLAN-DS1-MIB", "portConnectStringDelay"), ("PERLE-IOLAN-DS1-MIB", "snmpCommunityName"), ("PERLE-IOLAN-DS1-MIB", "defUserPortRWAccessAllowed"), ("PERLE-IOLAN-DS1-MIB", "userTcpClearPort"), ("PERLE-IOLAN-DS1-MIB", "tcpConnv6RemotePort"), ("PERLE-IOLAN-DS1-MIB", "routev6Metric"), ("PERLE-IOLAN-DS1-MIB", "userSessionTelnetPort"), ("PERLE-IOLAN-DS1-MIB", "serviceAutoDiscovery"), ("PERLE-IOLAN-DS1-MIB", "ethStatsPointtoPoint"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsTxRequests"), ("PERLE-IOLAN-DS1-MIB", "modbusMainUDPStatsSerialMode"), ("PERLE-IOLAN-DS1-MIB", "portUDPDirection"), ("PERLE-IOLAN-DS1-MIB", "portMultihostOutboundTcpPort"), ("PERLE-IOLAN-DS1-MIB", "serviceSnmpD"), ("PERLE-IOLAN-DS1-MIB", "portVmodemDTR"), ("PERLE-IOLAN-DS1-MIB", "portHdwTXDriverControl"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalStatusType"), ("PERLE-IOLAN-DS1-MIB", "hostStatus"), ("PERLE-IOLAN-DS1-MIB", "portVmodemInitString"), ("PERLE-IOLAN-DS1-MIB", "userSessionTelnetEchoCC"), ("PERLE-IOLAN-DS1-MIB", "portBidirStatus"), ("PERLE-IOLAN-DS1-MIB", "ioRelayCfgDelay"), ("PERLE-IOLAN-DS1-MIB", "ethStatsDebug"), ("PERLE-IOLAN-DS1-MIB", "ethStatsTxQLen"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalExtCfgEnable"), ("PERLE-IOLAN-DS1-MIB", "ioRelayMultihostOutboundStatus"), ("PERLE-IOLAN-DS1-MIB", "portInboundFlowControl"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalOutputCfgType"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalOutputCfgDelay"), ("PERLE-IOLAN-DS1-MIB", "portHdwCustomSpeed"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalOutputCfgMode"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxDestUnreachs"), ("PERLE-IOLAN-DS1-MIB", "serverStatus"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalExtCfgConnMethod"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxMsgs"), ("PERLE-IOLAN-DS1-MIB", "ioRelayCfgPulseMode"), ("PERLE-IOLAN-DS1-MIB", "gatewayIpAddress"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsRxDiscards"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalStatusEnabled"), ("PERLE-IOLAN-DS1-MIB", "userSessionTimer"), ("PERLE-IOLAN-DS1-MIB", "ethStatsMacAddress"), ("PERLE-IOLAN-DS1-MIB", "portTelnetInterrupt"), ("PERLE-IOLAN-DS1-MIB", "userTelnetPort"), ("PERLE-IOLAN-DS1-MIB", "portUDPStartAddress"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalExtCfgLinkChannel"), ("PERLE-IOLAN-DS1-MIB", "modbusGatewayUIDAddressMode"), ("PERLE-IOLAN-DS1-MIB", "portPhone"), ("PERLE-IOLAN-DS1-MIB", "trueportCustom110"), ("PERLE-IOLAN-DS1-MIB", "tcpConnv6TxQueueBytes"), ("PERLE-IOLAN-DS1-MIB", "ioAnalogStatusMaximum"), ("PERLE-IOLAN-DS1-MIB", "ethStatsNoTrailers"), ("PERLE-IOLAN-DS1-MIB", "serverTFTPHost"), ("PERLE-IOLAN-DS1-MIB", "modbusSubordinateTCPStatsGatewayResponses"), ("PERLE-IOLAN-DS1-MIB", "serverAutoObtainGW"), ("PERLE-IOLAN-DS1-MIB", "portName"), ("PERLE-IOLAN-DS1-MIB", "udpV6noPorts"), ("PERLE-IOLAN-DS1-MIB", "portHdwParity"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxGroupMembQueries"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsRxHdrErrors"), ("PERLE-IOLAN-DS1-MIB", "udpConnv6RemoteAddress"), ("PERLE-IOLAN-DS1-MIB", "userName"), ("PERLE-IOLAN-DS1-MIB", "modemName"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalStatusEnabled"), ("PERLE-IOLAN-DS1-MIB", "ioLineMultihostOutboundSigTcpPort"), ("PERLE-IOLAN-DS1-MIB", "portHdwOverruns"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxTimeExcds"), ("PERLE-IOLAN-DS1-MIB", "portHdwTxBytes"), ("PERLE-IOLAN-DS1-MIB", "portROAccessAllowed"), ("PERLE-IOLAN-DS1-MIB", "ioLineExtSigCfgMultiHost"), ("PERLE-IOLAN-DS1-MIB", "ioFailsafeEnable"), ("PERLE-IOLAN-DS1-MIB", "udpV6RxDatagrams"), ("PERLE-IOLAN-DS1-MIB", "ioLineSignalCfgStatus"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsTxForwDatagrams"), ("PERLE-IOLAN-DS1-MIB", "icmpV6TxParmProblems"), ("PERLE-IOLAN-DS1-MIB", "modbusGatewayCharacterTimeout"), ("PERLE-IOLAN-DS1-MIB", "ipV6StatsReasmOKs"), ("PERLE-IOLAN-DS1-MIB", "ioDigitalInputCfgLatch"), ) )
