...
jnxVirtualChassisMemberRole = MibTableColumn((1, 3, 6, 1, 4, 1, 2636, 3, 40, 1, 4, 1, 1, 1, 3), Integer().subtype(subtypeSpec=SingleValueConstraint(3,2,1,)).subtype(namedValues=NamedValues(("main", 1), ("backup", 2), ("linecard", 3), ))).setMaxAccess("readonly")
if mibBuilder.loadTexts: jnxVirtualChassisMemberRole.setDescription("Specifies whether the virtual-chassis member is of the type:\nmain(1), backup(2), linecard (3) ")
