...
nsrpVsdGroupCntToMain = MibTableColumn((1, 3, 6, 1, 4, 1, 3224, 6, 2, 1, 1, 8), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: nsrpVsdGroupCntToMain.setDescription("number of state transition into main state")
...
nsrpVsdGroupCntMainConflict = MibTableColumn((1, 3, 6, 1, 4, 1, 3224, 6, 2, 1, 1, 13), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: nsrpVsdGroupCntMainConflict.setDescription("number of times multiple mains exist while the local unit is\nin main state.")
...
nsrpVsdMemberStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 3224, 6, 2, 2, 1, 3), Integer().subtype(subtypeSpec=SingleValueConstraint(1,6,2,0,5,3,4,)).subtype(namedValues=NamedValues(("undefined", 0), ("init", 1), ("main", 2), ("primary-backup", 3), ("backup", 4), ("ineligible", 5), ("inoperable", 6), ))).setMaxAccess("readonly")
