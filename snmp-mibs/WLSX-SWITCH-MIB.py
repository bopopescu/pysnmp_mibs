...
wlsxSwitchRole = MibScalar((1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 1, 4), Integer().subtype(subtypeSpec=SingleValueConstraint(2,3,1,)).subtype(namedValues=NamedValues(("main", 1), ("local", 2), ("standbymain", 3), ))).setMaxAccess("readonly")
if mibBuilder.loadTexts: wlsxSwitchRole.setDescription("Role of this switch in the Switch Domain.")
wlsxSwitchMainIp = MibScalar((1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 1, 5), IpAddress()).setMaxAccess("readonly")
if mibBuilder.loadTexts: wlsxSwitchMainIp.setDescription("\nMain IP of the switch")
wlsxSwitchListTable = MibTable((1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 1, 6))
if mibBuilder.loadTexts: wlsxSwitchListTable.setDescription("This Table will list all the switches in the Switch Domain.\nIt will be populated only on the main switch. Local switches\nreturn empty table.")
...
switchListSwitchRole = MibTableColumn((1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 1, 6, 1, 2), Integer().subtype(subtypeSpec=SingleValueConstraint(2,3,1,)).subtype(namedValues=NamedValues(("main", 1), ("local", 2), ("standbymain", 3), ))).setMaxAccess("readonly")
...
wlsxVrMainIp = MibScalar((1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 100, 100, 20), IpAddress()).setMaxAccess("readonly")
if mibBuilder.loadTexts: wlsxVrMainIp.setDescription("\nThis Object contains the Main IP address.")
wlsxVrrpOperState = MibScalar((1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 100, 100, 21), Integer().subtype(subtypeSpec=SingleValueConstraint(1,3,2,)).subtype(namedValues=NamedValues(("initialize", 1), ("backup", 2), ("main", 3), ))).setMaxAccess("readonly")
...
wlsxVrrpStateChange = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 100, 1038)).setObjects(*(("WLSX-SWITCH-MIB", "wlsxVrrpOperState"), ("WLSX-SWITCH-MIB", "wlsxVrMainIp"), ("WLSX-SWITCH-MIB", "wlsxVrID"), ) )
