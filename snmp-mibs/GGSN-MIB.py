...
ggsnGtpcRole = MibTableColumn((1, 3, 6, 1, 4, 1, 10923, 1, 1, 1, 1, 2, 1, 1, 5), Integer().subtype(subtypeSpec=SingleValueConstraint(4,1,2,3,)).subtype(namedValues=NamedValues(("unknown", 1), ("main", 2), ("subordinate", 3), ("standby", 4), ))).setMaxAccess("readonly")
if mibBuilder.loadTexts: ggsnGtpcRole.setDescription("The current role of the GGSN-C (GTP-C) PIC. \n1. unknown \n2. main = node controller \n3. subordinate = session controller \n4. standby")
