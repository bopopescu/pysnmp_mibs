...
wlsxSysExtSwitchMainIp = MibScalar((1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 2, 1, 5), IpAddress()).setMaxAccess("readonly")
if mibBuilder.loadTexts: wlsxSysExtSwitchMainIp.setDescription("\nSwitch IP of the main controller.")
