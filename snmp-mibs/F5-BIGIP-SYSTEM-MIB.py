...
sysInterfacePhyMain = MibTableColumn((1, 3, 6, 1, 4, 1, 3375, 2, 1, 2, 4, 1, 2, 1, 21), Integer().subtype(subtypeSpec=SingleValueConstraint(1,3,0,2,)).subtype(namedValues=NamedValues(("subordinate", 0), ("main", 1), ("auto", 2), ("none", 3), ))).setMaxAccess("readonly")
if mibBuilder.loadTexts: sysInterfacePhyMain.setDescription("The configured SFP media type of the specified interface.")
...
sysStpInterfaceMbrRole = MibTableColumn((1, 3, 6, 1, 4, 1, 3375, 2, 1, 2, 10, 3, 2, 1, 5), Integer().subtype(subtypeSpec=SingleValueConstraint(1,3,0,5,4,2,)).subtype(namedValues=NamedValues(("disable", 0), ("root", 1), ("designate", 2), ("alternate", 3), ("backup", 4), ("main", 5), ))).setMaxAccess("readonly")
...
sysStpInterfaceTreeStatStatRole = MibTableColumn((1, 3, 6, 1, 4, 1, 3375, 2, 1, 2, 10, 8, 2, 1, 6), Integer().subtype(subtypeSpec=SingleValueConstraint(1,3,0,5,4,2,)).subtype(namedValues=NamedValues(("disable", 0), ("root", 1), ("designate", 2), ("alternate", 3), ("backup", 4), ("main", 5), ))).setMaxAccess("readonly")
